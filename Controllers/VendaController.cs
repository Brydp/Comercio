    ...
    public class VendaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Venda != null ? 
                          ...
                          Problem("Entity set 'Contexto.Venda'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DataVenda")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataVenda")] Venda venda)
        {
            if (id != venda.Id)
            {
                return NotFound();
